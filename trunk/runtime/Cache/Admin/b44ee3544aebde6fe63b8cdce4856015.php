...
<script language="javascript" type="text/javascript" src="<?php echo ($config_siteurl); ?>statics/js/jquery.js"></script>
<style type="text/css">
...
.header h1{
	background-image:url(<?php echo ($config_siteurl); ?>statics/images/logo.gif);background-repeat:no-repeat;width:227px;height:78px;line-height:150px;overflow:hidden;font-size:0}
        ...
        <form id="loginform" method="post" name="loginform" action="<?php echo U('Public/tologin');?>"   >
          <ul class="login_list"  id="web_login">
            ...
            <li class="yanzhengma clearfix" id="verifytip"> <span id="verifyinput">
              ...
              <div class="yanzhengma_box" id="verifyshow"> <img class="yanzheng_img" id="code_img" alt="" src="<?php echo U('Api/Checkcode/index','code_len=4&font_size=20&width=130&height=50&font_color=&background=');?>"><a href="javascript:document.getElementById('code_img').src='<?php echo U('Api/Checkcode/index','code_len=4&font_size=20&width=130&height=50&font_color=&background=');?>&time='+Math.random();void(0);" class="change_img">看不清，换一张</a> </div>
            </li>
            <li>
