DROP TABLE IF EXISTS `shuipfcms_vote`;
CREATE TABLE `shuipfcms_vote` (
...
DROP TABLE IF EXISTS `shuipfcms_vote_data`;
CREATE TABLE `shuipfcms_vote_data` (
...
DROP TABLE IF EXISTS `shuipfcms_vote_option`;
CREATE TABLE `shuipfcms_vote_option` (
