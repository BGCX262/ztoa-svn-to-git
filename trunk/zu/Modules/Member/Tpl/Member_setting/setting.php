  ...
  <div class="J_tabs_contents">
    <div class="table_full">
      ...
      <table width="100%" class="table_form">
        ...
        <tr>
          <th width="200">注册选择模型</th>
          <td> 是<input type="radio" name="setting[choosemodel]"  class="input-radio" 
            <if condition=" $setting['choosemodel'] eq '1' ">checked</if>
            value='1'>
            否<input type="radio" name="setting[choosemodel]"  class="input-radio" 
            <if condition=" $setting['choosemodel'] eq '0' ">checked</if>
            value='0'> </td>
        </tr>
        <tr>
        ...
        <tbody>
          <tr>
            ...
            <td class="y-bg"> App key
              ...
              <a href="http://open.weibo.com/connect" target="_blank">点击注册</a></td>
          </tr>
          <tr>
            <th>QQ空间登陆</th>
            <td class="y-bg"> APP ID
              ...
              <a href="http://connect.qq.com/intro/login/" target="_blank">点击注册</a></td>
          </tr>
        </tbody>
      </table>
    </div>
