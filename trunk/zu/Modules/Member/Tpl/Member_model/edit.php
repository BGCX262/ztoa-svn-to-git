...
<div class="wrap J_check_wrap">
  ...
  <form name="myform" action="{:U('Member_model/edit')}" method="post" class="J_ajaxForm">
  ...
  <table width="100%" class="table_form">
		...
		<tr>
			<th>模型描述</th>
			<td>
			<input type="text" name="description" value="" class="input" id="description" size="80" value="{$data.description}"></input>
			</td>
		</tr>
		<tr>
			<th>是否禁用模型</th>
