...
<div class="wrap ">
  ...
  <table width="100%" cellspacing="0">
      <form action="{:U("Contents/Create_html/update_urls")}" method="post" name="myform">
        ...
        <tbody  height="200" class="nHover td-line">
          ...
          <tr>
            <th>更新最新发布的
              <input type="text" name="number" value="100" size="5">
              条信息
              <input type="button" class="btn" name="dosubmit2" value=" 开始更新 " onclick="myform.type.value='lastinput';myform.submit();"></th>
          </tr>
          <tr>
            <th>更新发布时间从
              <input type="text" name="fromdate" id="fromdate" value="0" class="input" size="8" />
              &nbsp; 到
...
<script language="JavaScript">
	function change_model(modelid) {
		window.location.href=GV.DIMAUB+'index.php?a=update_urls&m=Create_html&g=Contents&modelid='+modelid;
	}
</script>
</body>
</html>