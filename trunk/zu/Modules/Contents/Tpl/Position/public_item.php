...
<div class="wrap J_check_wrap">
  ...
  <form name="myform" class="J_ajaxForm" action="{:U("Contents/Position/public_item")}" method="post">
    ...
    <div class="">
      <div class="btn_wrap_pd">
        <button class="btn btn_submit mr10 J_ajax_submit_btn" data-action="{:U("Contents/Position/public_item_listorder")}" type="submit">排序</button>
