  ...
  <table width="100%" cellspacing="0" >
        ...
        <volist name="data" id="vo">
          <tr>
            ...
            <td align='center'><font color="red"><if condition="$vo['issystem'] eq 1">√<else /> ╳</if></font></td>
            <td align='center'><font color="red"><if condition="$vo['minlength'] eq 1">√<else /> ╳</if></font></td>
            <td align='center'><font color="red"><if condition="$vo['issearch'] eq 1">√<else /> ╳</if></font></td>
            <td align='center'><font color="blue"><if condition="$vo['isorder'] eq 1">√<else /> ╳</if></font></td>
            <td align='center'><font color="red"><if condition="$vo['isadd'] eq 1">√<else /> ╳</if></font></td>
            <td align='center'>
