...
<div class="wrap J_check_wrap">
  <div class="nav">
    <ul class="cc">
      <li><a href="{:U("Sitemodel_field/index",array("modelid"=>$modelid))}">管理模型字段</a></li>
      <li  class="current"><a href="{:U("Sitemodel_field/add",array("modelid"=>$modelid))}">添加字段</a></li>
      <li ><a href="{:U("Sitemodel_field/priview",array("modelid"=>$modelid))}"  target="_blank">预览模型</a></li>
    </ul>
  </div>
  <div class="h_a">字段属性</div>
  <form name="myform" class="J_ajaxForm" action="{:U("Sitemodel_field/add")}" method="post">
