        ...
        <volist name="data" id="vo">
          <tr>
            ...
            <td><select name="replacement[{$vo.id}]" onChange="replaces({$vo.id},this.value);" >
              ...
              <input class="input-text" type="text" size="30" name="replacontent[{$vo.id}]" id="replacontent_{$vo.id}" <if condition=" in_array($vo['replacement'],array('{BANNED}','{MOD}'))  "> style="display:none" value="" disabled<else/>value="{$vo['replacement']}"</if>  >
              </td>
            <td>
