  ...
  <table width="100%" height="100%" style="table-layout:fixed;">
    <tr class="head">
      ...
      <td><div class="nav"> 
        ...
        <div class="login_info"><a href="#" class="home" onclick="leftmenu();">关闭/打开 左侧菜单</a>&nbsp;&nbsp; <span class="mr10">{$User.role_name}： {$User.username}</span><a href="{:U('Public/logout')}" class="mr10">[注销]</a><a href="{$Config.siteurl}" class="home" target="_blank">前台首页</a><a href="{:U('Member/Index/index')}" class="home" target="_blank">会员中心</a><a href="javascript:;;" id="deletecache" class="home"  style="color:#FFF">缓存更新</a></div></td>
    </tr>
    <tr class="tab">
      <th><div class="search">
          <input size="15" placeholder="Hi，85zu！" id="J_search_keyword" type="text">
    ...
    <tr class="content">
      <th  style="overflow:hidden; display: ;" id="leftmenuid">
        <div id="B_menunav">
          <div class="menubar">
            <dl id="B_menubar">
...
$('#J_fullScreen').toggle(function (e) {
    ...
    if(document.getElementById('leftmenuid').style.display == ''){
        $('#B_frame').attr("colspan",1);
    }else{
        $('#B_frame').attr("colspan",2);
    }
...
function leftmenu(){
    if(document.getElementById('leftmenuid').style.display == ''){
        document.getElementById('leftmenuid').style.display = 'none';
        $('#B_frame').attr("colspan",2);
    }else{
        document.getElementById('leftmenuid').style.display = '';
        $('#B_frame').attr("colspan",1);
    }
}
