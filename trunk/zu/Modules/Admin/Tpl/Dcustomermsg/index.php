            ...
            <div class="table_list">
                <table width="100%" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td width="10%">开户行</td>
                        <td width="5%">录入人</td>
                        <td class="acenter" width="5%">操作</td>
                    </tr>
                    </thead>
                    <tbody id="list-data">
        ...
        success: function(json){
            ...
            if(json.error=='' || json.error==null || json.error==undefined){
                ...
                $(json.list).each(function(){
                    ...
                    td = tr.insertCell(-1);//
                    td.appendChild(document.createTextNode(this.customer));
                    ...
                    td = tr.insertCell(-1);//
                    td.appendChild(document.createTextNode(this.bank_name));

                    var stsname = (this.status == 1) ? '显示':'不显示';
                    td = tr.insertCell(-1);//
                    td.appendChild(document.createTextNode(this.cardno));

                    td = tr.insertCell(-1);//
                    td.appendChild(document.createTextNode(this.oc_bank));
                   ...
                   /* var div = document.createElement('div');
                    ...
                    tda.href = "http://www.85zu.com";
                    tda.target = "_blank";
                    tda.appendChild(document.createTextNode("出团单"));
                    ...
                    if('{$menurole.a_m}'=='Y'){
                        var tda = document.createElement("a");
                        tda.href = "{:U('Dcusperson/personadd')}&id="+id+"&menuid="+{$menuinfo['id']}+"&t=a&param="+encodeURIComponent(JSON2.stringify(param));
