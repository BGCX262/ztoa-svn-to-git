...
<div class="wrap J_check_wrap">
    ...
    <form class="J_ajaxForm" name="myform" id="myform" action="{:U('Dwtfperson/personsave')}" method="post">
                ...
                <div class="table_full">
                    <table cellpadding="0" cellspacing="0" class="table_form"  width="100%">
                        ...
                        <foreach name="info" item="vo">
                            <tr>
                                <th class="w10 ">{$vo.name}</th>
                                <td class="w5">{$vo.sex}</td>
                                <th  class="w10 ">{$vo.dept}</th>
                                <td class="w10">{$vo.wtf_group}</td>
                ...
                <div class="table_full">
                    <table cellpadding="0" cellspacing="0" class="table_form"  width="100%">
                        ...
                        <tr>
                            ...
                            <td class="w20"><input type="text" class="input  length_2" name="wtf_group" id="wtf_group"  value="{$pinfo.wtf_group}"></td>
