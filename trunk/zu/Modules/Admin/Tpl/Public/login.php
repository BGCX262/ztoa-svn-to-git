...
<meta charset="utf-8" />
<title>系统后台 - {$Config.sitename} - by 85zu</title>
<meta name="generator" content="ThinkPHP lxsoazt" />
...
.header h1{
	background-image:url({$config_siteurl}statics/images/logo1.gif);background-repeat:no-repeat;width:227px;height:78px;line-height:150px;overflow:hidden;font-size:0}
...
<div class="footer">
  <div class="inner">
    <div class="copyright clearfix">
      <p class="copyright_en">Copyright &copy; 2009 - <?php echo date('Y');?> . All Rights Reserved.</p>
      <!--<p class="copyright_ch">a</p>-->
    </div>
  </div>
</div>
