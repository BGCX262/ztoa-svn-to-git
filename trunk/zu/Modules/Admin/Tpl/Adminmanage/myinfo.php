    ...
    <div class="table_full">
      <table width="100%">
        ...
        <tr>
          ...
          <tr>
              <th>每页显示</th>
              <td><input name="pagesize" type="text" class="input length_5" value="{$data.pagesize}"></td>
          </tr>
          <tr>
              <th>行高</th>
              <td><input name="height" type="text" class="input length_5" value="{$data.height}"></td>
          </tr>
          <tr>
              <th>字体名称</th>
              <td><input name="fontname" type="text" class="input length_5" value="{$data.fontname}"></td>
          </tr>
          <tr>
              <th>字体大小</th>
              <td><input name="fontsize" type="text" class="input length_5" value="{$data.fontsize}"></td>
          </tr>
