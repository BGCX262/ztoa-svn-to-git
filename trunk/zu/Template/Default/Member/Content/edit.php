...
<div id="memberArea">
  ...
  <div class="col-auto">
		<div class="col-1 ">
			...
			<div class="content">
			<form method="post" action="{:U('Content/edit')}" id="myform" name="myform" class="J_ajaxForms" enctype="multipart/form-data">
			<input type="hidden" name="id" value="{$id}" />
				<table width="100%" cellspacing="0" class="table_form">
					<tr>
						<th>栏目：</th>
						<td><input type="hidden" name="info[catid]" value="{$catid}" />{$Categorys[$catid]['catname']}</td>
					</tr>
					<?php
