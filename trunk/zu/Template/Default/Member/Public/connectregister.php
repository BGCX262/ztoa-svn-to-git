...
<div id="content">
  <h2>{$connect.name}会员注册&nbsp;&nbsp;&nbsp;&nbsp;<span class="on"><em>1</em>填写信息</span> </h2>
  <form method="post" action="" id="myform">
    <div class="col-left form-login form-reg">
      <div class="input-lins">
        <label>用户名：</label>
        <input type="text" id="username" name="username" size="36" class="input" value="{$connect.userinfo.name}">
      </div>
      <div class="input-lins">
        <label>密码：</label>
  ...
  <div class="col-auto reg-auto">
    <p class="f14"> 已经有了账号？<br />
      请直接绑定登录 </p>
    <div class="submit">
      <input type="submit" name="dosubmit" value="已有帐号绑定" onclick="redirect('{:U("Member/Index/public_binding")}')">
    </div>
  </div>
</div>
