...
<title>{$Config.sitename} - 会员帐号绑定 - 会员管理中心</title>
...
<div id="content">
  <div class="col-left form-login" id="logindiv">
    <form method="post" action="{:U("Member/Index/public_binding")}" onsubmit="save_username();" id="myform" name="myform">
      ...
      <div class="take">
        ...
        <div class="submit">
          <input type="submit" name="dosubmit" id="dosubmit" value="绑定">
        </div>
      </div>
    </form>
  </div>
